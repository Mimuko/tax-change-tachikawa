...
test("reference.tokyo は配列として存在する", () => {
  assert.ok(Array.isArray(data.reference?.tokyo));
});

test("reference.tokyo の賃金系列は2020以降の円建て実値を持つ", () => {
  const salary = data.reference.tokyo.find(
  ...
  assert.ok(salary.points.length >= 4);
