  ...
  gaps: [
    {
      ...
      title: "立川市だけの不登校の年次推移を確認できるデータはありません。",
      reason:
        "文部科学省の調査は都道府県・指定都市単位で公表されています。東京都全体の値は、立川市の実績としては扱っていません。",
      note: "また、市が公表している『不就学』は『不登校』とは定義が異なるため、代替指標としては使用していません。",
    },
    {
      ...
      title:
        "立川市の教育費データはありますが、複数年を同じ条件で比較できるか確認中のため、今回は推移には掲載していません。",
      reason: "公表値は会計年度の実績です。",
      note: "児童生徒数から独自に1人あたりの金額を計算することはしていません。",
    },
  ],
};
